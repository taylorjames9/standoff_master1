...
{   
	    ...
	    lineR.SetPosition(0, Vector3(NPCPos.x,NPCPos.y-1,NPCPos.z));
	    lineR.SetPosition(1, Vector3(NPCPos2.x,NPCPos2.y-1,NPCPos2.z));
	    
	    /*var lineR_2 = gameObject.AddComponent(LineRenderer);
